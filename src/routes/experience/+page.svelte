        ...
        {#each experiences as exp (exp.jobTitle)}
          ...
          >
            ...
            <div class="text-sm text-base-content/60">
              ...
              <p class="flex items-center gap-2">
                <span class="text-primary">●</span>
                {exp.startDate} - {exp.currentlyWorking
                  ? "Present"
                  : (exp.endDate ?? "")}
              </p>
              {#if exp.industry}
            ...
            <p
              class="text-sm text-base-content/80 pt-3 border-t border-base-content/10"
            >
              {exp.description}
            </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        {#each certifications as cert (cert.certificationName)}
          ...
          >
            ...
            {#if cert.description}
              <p
                class="text-xs text-base-content/70 pt-2 border-t border-base-content/10"
              >
                {cert.description}
              </p>
            {/if}
